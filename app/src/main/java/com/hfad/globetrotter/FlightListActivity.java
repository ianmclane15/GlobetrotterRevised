...
public class FlightListActivity extends AppCompatActivity {
    ...
    private void populateListView() {
        ...
        carrierArray = (Carrier[])getIntent().getParcelableArrayExtra("carriers");
        List<Carrier> carriers = Arrays.asList(carrierArray);
        ArrayAdapter<Carrier> arrayAdapter = new ArrayAdapter<Carrier>(this, android.R.layout.simple_list_item_1, carriers);
